...
function update_ot($con,$id,$code,$name,$ot1,$ot2,$ot3,$ot4,$rate){
	$Sql = "UPDATE con_ot_name SET code='".$code."',name='".$name."',normal_ot='".$ot1."',weekend_ot='".$ot2."',holiday_ot='".$ot3."',8_hours='".$ot4."',rate='".$rate."' WHERE id LIKE '".$id."' ";
...
function insert_ot($con,$code,$name,$ot1,$ot2,$ot3,$ot4,$rate){
	$Sql = "INSERT INTO con_ot_name (code,name,normal_ot,weekend_ot,holiday_ot,8_hours,rate) VALUES ('".$code."','".$name."','".$ot1."','".$ot2."','".$ot3."','".$ot4."','".$rate."') ";
...
if(isset($_POST['save'])){
	switch ($_POST['ot_type']){
		case 'holiday_before_8':
			$ot1 = 0;
			$ot2 = 0;
			$ot3 = 1;
			$ot4 = 0;
			break;
		case 'holiday_after_8':
			$ot1 = 0;
			$ot2 = 0;
			$ot3 = 1;
			$ot4 = 1;
			break;
		case 'weekend_before_8':
			$ot1 = 0;
			$ot2 = 1;
			$ot3 = 0;
			$ot4 = 0;
			break;
		case 'weekend_after_8':
			$ot1 = 0;
			$ot2 = 1;
			$ot3 = 0;
			$ot4 = 1;
	...
	if(!check_ot($con,$_POST['code']) && $id = insert_ot($con,$_POST['code'],$_POST['name'],$ot1,$ot2,$ot3,$ot4,$_POST['rate'])){
	...
	if(update_ot($con,$_POST['id'],$_POST['code'],$_POST['name'],$ot1,$ot2,$ot3,$ot4,$_POST['rate'])){
