    ...
    <div id="wrap">
        <div class="container">
            <div class="row">
				...
				<a href="/converter/"><img src="assets/logo.png" alt="TimeTracX" style="float:left;"><i style="font-size:55px;"> - Payroll Integrator</i></a>
				</div>
				<ul class="nav nav-tabs">
					<!--<li class="active"><a href="#index" data-toggle="tab">Converter <sup>Legacy</sup></a></li>-->
					<!--<li class="active"><a href="#overtime" data-toggle="tab">Overtime</a></li>
					<li><a href="#shift" data-toggle="tab">Shift Allowance</a></li>
					<li><a href="#meal" data-toggle="tab">Meal Allowance</a></li>
					<li><a href="#attendance" data-toggle="tab">Attendance Allowance</a></li>
					<li><a href="#hardship" data-toggle="tab">Hardship Allowance</a></li>-->
					<li class="active"><a href="#sql" data-toggle="tab">SQL Payroll</a></li>
					<li><a href="#kakitangan" data-toggle="tab">Kakitangan</a></li>
				</ul>
                <div class="tab-content">
					<!--<div id="overtime" class="tab-pane fade in active">
						<br>
